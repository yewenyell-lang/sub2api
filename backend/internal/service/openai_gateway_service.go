...
func (s *OpenAIGatewayService) resolveFreshSchedulableOpenAIAccount(ctx context.Context, account *Account, requestedModel string, requireCompact bool) *Account {
	return s.resolveFreshSchedulableOpenAIAccountWithCodexCheck(ctx, account, requestedModel, requireCompact, true)
}

func (s *OpenAIGatewayService) resolveFreshSchedulableOpenAIAccountWithCodexCheck(ctx context.Context, account *Account, requestedModel string, requireCompact bool, checkCodex bool) *Account {
	if account == nil {
		return nil
	}
...
func (s *OpenAIGatewayService) recheckSelectedOpenAIAccountFromDB(ctx context.Context, account *Account, requestedModel string, requireCompact bool) *Account {
	return s.recheckSelectedOpenAIAccountFromDBWithCodexCheck(ctx, account, requestedModel, requireCompact, true)
}

func (s *OpenAIGatewayService) recheckSelectedOpenAIAccountFromDBWithCodexCheck(ctx context.Context, account *Account, requestedModel string, requireCompact bool, checkCodex bool) *Account {
	if account == nil {
		return nil
	}
