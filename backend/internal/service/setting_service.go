...
type SettingService struct {
	...
	ourVersion                string // Fork/custom version
...
// SetOurVersion sets the fork/custom version for injection into public settings.
func (s *SettingService) SetOurVersion(ourVersion string) {
	s.ourVersion = ourVersion
}
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	if v, ok := settings[openAIAdvancedSchedulerSettingKey]; ok && v != "" {
		result.OpenAIAdvancedSchedulerEnabled = v == "true"
	} else {
