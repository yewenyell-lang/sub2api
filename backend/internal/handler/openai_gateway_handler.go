...
func (h *OpenAIGatewayHandler) Responses(c *gin.Context) {
	...
	if imageIntent && !imageGenerationAllowed && service.IsOpenAIImageGenerationModel(reqModel) {
...
func (h *OpenAIGatewayHandler) ResponsesWebSocket(c *gin.Context) {
	...
	if service.IsImageGenerationIntent("/v1/responses", reqModel, firstMessage) && !service.GroupAllowsImageGeneration(apiKey.Group) && service.IsOpenAIImageGenerationModel(reqModel) {
