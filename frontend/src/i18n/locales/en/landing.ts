export default {
  ...
  keyUsage: {
    ...
    groupDefaultRate: 'Group Default Rate',
    userRate: 'User Rate',
    effectiveRate: 'Effective Rate',
    rateSource: 'Rate Source',
    rateSourceUser: 'User Override',
    rateSourceGroup: 'Group Default',
    imageRate: 'Image Rate',
    imageRateMode: 'Image Rate Mode',
    imageRateIndependent: 'Independent',
    imageRateShared: 'Follows Group',
